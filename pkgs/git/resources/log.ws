...
fn section() -> string { "log" }

fn keys() -> List[string] {
    ["date", "decorate", "follow", "abbrevCommit", "showSignature", "mailmap",
     "graphColors", "diffMerges", "showRoot"]
}

fn allowed() -> Map[string, List[string]] {
    #{
        "decorate": ["short", "full", "auto", "no"],
        "diffMerges": ["off", "none", "on", "first-parent", "separate",
                       "combined", "dense-combined", "remerge"],
    }
}
